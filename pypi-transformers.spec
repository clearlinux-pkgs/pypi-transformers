...
Version  : 4.43.3
Release  : 23
URL      : https://files.pythonhosted.org/packages/e8/05/b742809e144fb6ee66dd32a9f6337e0f19cde87472e47a33916d23555e69/transformers-4.43.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/e8/05/b742809e144fb6ee66dd32a9f6337e0f19cde87472e47a33916d23555e69/transformers-4.43.3.tar.gz
...
%prep
%setup -q -n transformers-4.43.3
cd %{_builddir}/transformers-4.43.3
pushd ..
cp -a transformers-4.43.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722276974
