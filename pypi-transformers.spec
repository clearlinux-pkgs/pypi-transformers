...
Version  : 4.39.1
Release  : 9
URL      : https://files.pythonhosted.org/packages/33/29/e4ee6583200a9a5950ff51b1190b95e41d267fbf5e9bef26e7d6a9647cba/transformers-4.39.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/33/29/e4ee6583200a9a5950ff51b1190b95e41d267fbf5e9bef26e7d6a9647cba/transformers-4.39.1.tar.gz
...
%prep
%setup -q -n transformers-4.39.1
cd %{_builddir}/transformers-4.39.1
pushd ..
cp -a transformers-4.39.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711241190
