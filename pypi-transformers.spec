...
Version  : 4.50.3
Release  : 53
URL      : https://files.pythonhosted.org/packages/c0/29/37877123d6633a188997d75dc17d6f526745d63361794348ce748db23d49/transformers-4.50.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/c0/29/37877123d6633a188997d75dc17d6f526745d63361794348ce748db23d49/transformers-4.50.3.tar.gz
...
%prep
%setup -q -n transformers-4.50.3
cd %{_builddir}/transformers-4.50.3
pushd ..
cp -a transformers-4.50.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743432244
