...
Version  : 4.41.0
Release  : 15
URL      : https://files.pythonhosted.org/packages/fc/ac/40ff13cd5742fc5a5ab0f5fce7225946f748153cd4a81d82537199555057/transformers-4.41.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/fc/ac/40ff13cd5742fc5a5ab0f5fce7225946f748153cd4a81d82537199555057/transformers-4.41.0.tar.gz
...
%prep
%setup -q -n transformers-4.41.0
cd %{_builddir}/transformers-4.41.0
pushd ..
cp -a transformers-4.41.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716090960
