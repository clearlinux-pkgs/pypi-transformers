...
Version  : 4.41.1
Release  : 16
URL      : https://files.pythonhosted.org/packages/fb/56/8e6c1997a979b900178c56e4ab89ba1b7588a2e2dc646c261334a2846e0a/transformers-4.41.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/fb/56/8e6c1997a979b900178c56e4ab89ba1b7588a2e2dc646c261334a2846e0a/transformers-4.41.1.tar.gz
...
%prep
%setup -q -n transformers-4.41.1
cd %{_builddir}/transformers-4.41.1
pushd ..
cp -a transformers-4.41.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716483439
