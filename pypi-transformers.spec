...
Version  : 4.39.0
Release  : 8
URL      : https://files.pythonhosted.org/packages/18/b6/889fc9f368dc33940097f3873ca694c3c178890c5fe7dedab7dff6322656/transformers-4.39.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/18/b6/889fc9f368dc33940097f3873ca694c3c178890c5fe7dedab7dff6322656/transformers-4.39.0.tar.gz
...
%prep
%setup -q -n transformers-4.39.0
cd %{_builddir}/transformers-4.39.0
pushd ..
cp -a transformers-4.39.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711033874
