...
Version  : 4.44.0
Release  : 31
URL      : https://files.pythonhosted.org/packages/44/e8/df0ee2b9c86d4e5fe467aec19389573b8f24eeeca0120f55da5315cd5210/transformers-4.44.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/44/e8/df0ee2b9c86d4e5fe467aec19389573b8f24eeeca0120f55da5315cd5210/transformers-4.44.0.tar.gz
...
%prep
%setup -q -n transformers-4.44.0
cd %{_builddir}/transformers-4.44.0
pushd ..
cp -a transformers-4.44.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723047473
