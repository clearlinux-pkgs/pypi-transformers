...
Version  : 4.40.0
Release  : 12
URL      : https://files.pythonhosted.org/packages/43/01/5f16275cf57489733d16fbe188d67ed70908d62d35cf26fe7243f1f15608/transformers-4.40.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/43/01/5f16275cf57489733d16fbe188d67ed70908d62d35cf26fe7243f1f15608/transformers-4.40.0.tar.gz
...
%prep
%setup -q -n transformers-4.40.0
cd %{_builddir}/transformers-4.40.0
pushd ..
cp -a transformers-4.40.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713468261
