...
Source0  : https://files.pythonhosted.org/packages/84/eb/259afff0df9ece338dc224007bbe7dd6c9aae8e26957dc4033a3ec857588/transformers-4.42.4.tar.gz
...
%prep
%setup -q -n transformers-4.42.4
cd %{_builddir}/transformers-4.42.4
pushd ..
cp -a transformers-4.42.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720800528
