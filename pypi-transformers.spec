...
Version  : 4.51.0
Release  : 54
URL      : https://files.pythonhosted.org/packages/38/75/6ebdae4d6f4574f47139a070445245537e43482d006f615af8e23d5bf05e/transformers-4.51.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/38/75/6ebdae4d6f4574f47139a070445245537e43482d006f615af8e23d5bf05e/transformers-4.51.0.tar.gz
...
%prep
%setup -q -n transformers-4.51.0
cd %{_builddir}/transformers-4.51.0
pushd ..
cp -a transformers-4.51.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744039985
