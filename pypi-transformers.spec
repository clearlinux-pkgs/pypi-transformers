...
Version  : 4.49.0
Release  : 49
URL      : https://files.pythonhosted.org/packages/79/50/46573150944f46df8ec968eda854023165a84470b42f69f67c7d475dabc5/transformers-4.49.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/79/50/46573150944f46df8ec968eda854023165a84470b42f69f67c7d475dabc5/transformers-4.49.0.tar.gz
...
%prep
%setup -q -n transformers-4.49.0
cd %{_builddir}/transformers-4.49.0
pushd ..
cp -a transformers-4.49.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739827861
